 ...
 */
public class UpdateRecipeStepRequestDTO {
    ...
    @NotBlank
    private Collection<UpdateRecipeIngredientRequestDTO> ingredients;
    ...
    public Collection<UpdateRecipeIngredientRequestDTO> getIngredients() {
        return ingredients;
    }

    public void setIngredients(Collection<UpdateRecipeIngredientRequestDTO> ingredients) {
